...
public class AnalysisHelper {
    ...
    public void getMaxLikeCommentpost() {
        ...
        System.out.println("Q2 - post with most likes per coment: " + data.getPosts().get(postId).getPostId());
    }
    ...
    public void getPassiveAndActiveOverallUsers() {
        ...
        System.out.println("07 - The following users have overall been active: ");
